Feature: Admin Panel
	...
	Scenario: Create companies
		...
		And there is a company type
		And there is a category
		And I follow "New Company"
		And I fill in "Name" with "Test Company"
		And I select "Test company type" from "Company type"
		And I select "Test category" from "Category"
	...
	Scenario: Create advertisements
		...
		And I select "Test category" from "Category 1"
